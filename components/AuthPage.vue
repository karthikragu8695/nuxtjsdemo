                       ...
                       <v-select
                        ...
                        <v-row>
                          <v-col cols="6">
                            ...
                            <v-text-field label="Brother" type="number" v-model="Brothers" variant="outlined"></v-text-field>
                          </v-col>
                          <v-col cols="6">
                         <v-text-field label="Sister" v-model="Sister" type="number" variant="outlined"></v-text-field>
                          </v-col>
                        </v-row>
...
const Brothers = ref(null)
const Sister = ref(null)
