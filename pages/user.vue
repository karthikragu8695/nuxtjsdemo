<template>
  <v-container>
      <v-row  >
        <v-col cols="4" class="w-full hidden">
                      ...
                      <v-dialog width="400" v-model="Maritaldialog">
                        <v-card class="px-5 py-10 ">
                          <v-row>
                            ...
                            <v-col cols="12">
                              <div>
                                <v-checkbox  label="Any"> </v-checkbox>
                                <v-checkbox  label="Awaiting Divorce"> </v-checkbox>
                                <v-checkbox label="Divorced"> </v-checkbox>
                                <v-checkbox label="Never Married"> </v-checkbox>
                                <v-checkbox label="Widower"> </v-checkbox>
                              </div>
                            </v-col>
                            <v-row>
                              <v-col cols="5">
                        ...
                        <v-card class="px-5 py-10 ">
                          <v-row>
                            ...
                            <v-col cols="12">
                              <div >
                                <v-checkbox  label="Any"></v-checkbox>
                                <v-checkbox  label="Hindu"></v-checkbox>
                              </div>
                            </v-col>
                            <v-row>
                              <v-col cols="5">
                        ...
                        <v-card class="px-5 py-10 ">
                          <v-row>
                            ...
                            <v-col cols="12">
                              <div >
                                <v-checkbox  label="Any"></v-checkbox>
                                <v-checkbox  label="Brahmin-maithil"></v-checkbox>
                                <v-checkbox  label="Brahmin-Bhumihar"></v-checkbox>
                                <v-checkbox  label="Kumhar"></v-checkbox>
                                <v-checkbox  label="Sundhi"></v-checkbox>
                              </div>
                            </v-col>
                            <v-row>
                              <v-col cols="5">
                        ...
                        <v-card class="px-5 py-10 ">
                          <v-row>
                            ...
                            <v-col cols="12">
                              <div >
                                <v-checkbox  label="Any"></v-checkbox>
                                <v-checkbox  label="Ardra/Thiruvathira"></v-checkbox>
                                <v-checkbox  label="Revathi"></v-checkbox>
                                <v-checkbox  label="Not Specified"></v-checkbox>
                              </div>
                            </v-col>
                            <v-row>
                              <v-col cols="5">
                      ...
                      <v-dialog width="400" v-model="Dhosamdialog">
                        <v-card class="px-5 py-10 ">
                          <v-row>
                            ...
                            <v-col cols="12">
                              <div >
                                <v-checkbox  label="Doesn't Matter"></v-checkbox>
                                <v-checkbox  label="Don't Know"></v-checkbox>
                                <v-checkbox  label="No Dhosham"></v-checkbox>
                                <v-checkbox  label="Not Specified"></v-checkbox>
                              </div>
                            </v-col>
                            <v-row>
                        ...
                        <v-card class="px-5 py-10 ">
                          <v-row>
                            ...
                            <v-col cols="12">
                              <div >
                                <v-checkbox  label="Any"></v-checkbox>
                                <v-checkbox  label="Administration"></v-checkbox>
                                <v-checkbox  label="BPO & Customer Service"></v-checkbox>
                                <v-checkbox  label="Education &Training "></v-checkbox>
                                <v-checkbox  label="Engineering "></v-checkbox>
                                <v-checkbox  label="others"></v-checkbox>
                              </div>
                            </v-col>
                            <v-row>
                              <v-col cols="5">
                        ...
                        <v-card class="px-5 py-10 ">
                          <v-row>
                            ...
                            <v-col cols="12">
                              <div >
                                <v-checkbox  label="Any"></v-checkbox>
                                <v-checkbox  label="Private"></v-checkbox>
                                <v-checkbox  label="Self employed"></v-checkbox>
                              </div>
                            </v-col>
                            <v-row>
                              <v-col cols="5">
                        ...
                        <v-card class="px-5 py-10 ">
                          <v-row>
                            ...
                            <v-col cols="12">
                              <div >
                                <v-checkbox  label="Any"></v-checkbox>
                                <v-checkbox  label="Bachelors - Engineering / Computers / Others"></v-checkbox>
                                <v-checkbox  label="Bachelors - Arts / Science / Commerce / others"></v-checkbox>
                              </div>
                            </v-col>
                            <v-row>
                              <v-col cols="5">
                        ...
                        <v-card class="px-5 py-10 ">
                          <v-row>
                            ...
                            <v-col cols="12">
                              <div >
                                <v-checkbox  label="Any"></v-checkbox>
                                <v-checkbox  label="India"></v-checkbox>
                              </div>
                            </v-col>
                            <v-row>
                              <v-col cols="5">
        ...
        <v-col cols="8" class="text-center">
         <v-container>
          <v-card>
            <v-row >
              <v-col cols="4">
                <v-img :width="400"  class="p-24 mx-5 my-5  rounded-xl" aspect-ratio="16/9" cover src="https://img.freepik.com/free-photo/portrait-young-man-talking-phone-walking-street_231208-2764.jpg" >
                </v-img>
              </v-col>
              <v-col cols="8">
                <v-col class="text-left  ml-10  w-full md:w-1/2 flex flex-col">
