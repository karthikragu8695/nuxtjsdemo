<template>
    <div class="px-10">
      <v-row >
        <v-col  lg="4"    class="hidden  lg:block"> 
        ...
        <v-col lg="8" md="8" sm="12"  >
                ...
                <v-window v-model="tab">
                  <v-card v-for="profile in profiles" :key="profile">
                    <v-window-item value="one" class="font-bold text-[15px]"> </v-window-item>
                          ...
                          <v-card class="px-5 py-10 ">
                            <v-row>
                              ...
                              <v-row>
                                ...
                                <v-col cols="3.5">
                                  <v-btn v-if="!language" @click="Maritaldialog=false">Apply</v-btn>
                      ...
                      <h2 v-if="!language" class="text-h6 font-semibold">Religious Details</h2>
                      <h2 v-else class=" font-semibold ">மத விவரங்கள்</h2>
                      <!-------------Religious--------->
                      <div  class="flex mt-5">
                        <v-row >
                          <v-col cols="4">
                        ...
                        <v-dialog width="400" v-model="Religiousdialog">
                          <v-card class="px-5 py-10 ">
                            <v-row>
                              ...
                              <v-col cols="12">
                                <div >
                                  <v-checkbox v-if="!language" v-model="Religious" value="Any" label="Any"></v-checkbox>
                        ...
                        <v-dialog width="400" v-model="EmploymentTypedialog">
                          <v-card class="px-5 py-10 ">
                            <v-row>
                              <v-col cols="12">
                                <div class="flex ">
                                  <h2 class="mt-2 font-bold" v-if="!language">Select Employment Type</h2>
                        ...
                        <v-dialog width="400" v-model="Educationdialog">
                          <v-card class="px-5 py-10 ">
                            <v-row>
                              <v-col cols="12">
                                <div class="flex ">
                                  <h2 class="mt-2 font-bold" v-if="!language">Select Education</h2>
                      ...
                      <h2  v-if="!language" class="text-h6 font-semibold">Location Details</h2>
                      <h2 v-else class=" font-semibold">இருப்பிட விவரங்கள்</h2>
                      <!---------------Country--------------->
                      <div  class="flex  mt-5">
                        <v-row >
                          <v-col cols="4">
          ...
          <v-container>
                ...
                <v-row v-for="profile in profileList" :key="profile.id" class="shadow-xl mx-5 my-5 rounded" >
